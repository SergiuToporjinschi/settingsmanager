...
void getTests() {
  ...
  Serial.print("CChar charTest: "); Serial.println(sm.getCChar("charTest"));
  ...
  Serial.print("char charTestN: "); Serial.println(sm.getSChar("charTestN"));
  Serial.print("char charTestN: "); Serial.println(sm.getSChar("charTestN", 'H'));
  Serial.print("char charTestNs default: "); Serial.println(sm.getSChar("charTestNs", 'H'));
  
  Serial.print("uchar charTestN: "); Serial.println(sm.getUChar("charTestN"));
